<template>
  ...
  <div class="app-container">
    ...
    <el-table :data="pageData">
      ...
      <el-table-column prop="mporduct" label="当月销售量"></el-table-column>
      <el-table-column prop="mbjl" label="冰激凌销售量"></el-table-column>
      <el-table-column prop="mwp" label="沃派销售量"></el-table-column>
      <el-table-column prop="mdx" label="低消激活量"></el-table-column>
      <el-table-column prop="mwlw" label="流量王激活量"></el-table-column>
    </el-table>
  </div>
</template>
<script>
...
//      let rs = [];
      ...
      for (let i = 1; i < 12; i++) {
        for (let j = 0; j < citys.length; j++) {
          ...
          mdata.mporduct = (mdata.mbjl + mdata.mwp + mdata.mdx + mdata.mwlw);
